...
export class AuthService {
  ...
  loginSocialUser(userSocialData: any): Observable<any> {
    return this.http.post(
      `${this.usersAPIURL}/auth/login/social`,
      userSocialData
    );
  }
  ...
  activeAccount(emailCode: any): Observable<any> {
    return this.http.patch(
      `${this.usersAPIURL}/auth/activate-account`,
      emailCode
    );
  }
  ...
  sendEmailPassword(email: any): Observable<any> {
    return this.http.post(
      `${this.usersAPIURL}/auth/reset-password/request`,
      email
    );
  }
  ...
  verifyCodePassword(info: any): Observable<any> {
    return this.http.post(
      `${this.usersAPIURL}/auth/reset-password/verify`,
      info
    );
  }
  ...
  updatePassword(user: any): Observable<any> {
    return this.http.patch(
      `${this.usersAPIURL}/auth/reset-password/change`,
      user
    );
  }
